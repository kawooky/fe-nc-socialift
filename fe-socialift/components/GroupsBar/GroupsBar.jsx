...
export const GroupsBar = ({navigation}) => {
    ...
    return (<ScrollView
      ...
      >
        <Pressable style={homeStyles.groupItem} onPress={() => navigation.navigate("CreateGroup", {groupId: null})}>
          ...
          <Text numberOfLines={1} style={homeStyles.groupName}>Create Group</Text>
